...
int main() {
  ...
  std::cout << "\nDate is GPS Week: " << w2.as_underlying_type()
            << ", SOW:" << sow2;
  w3 = d3.as_gps_wsow(sow3);
  std::cout << "\nDate is GPS Week: " << w3.as_underlying_type()
            << ", SOW:" << sow3;
  ...
  std::cout << "\nDate is GPS Week: " << w2.as_underlying_type()
            << ", MilliSeconds OW:" << mlsow.as_underlying_type();
  w3 = d3.as_gps_wsow(mcsow);
  std::cout << "\nDate is GPS Week: " << w3.as_underlying_type()
            << ", MicroSeconds OW:" << mcsow.as_underlying_type();
