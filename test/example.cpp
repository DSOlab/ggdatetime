...
int main()
{
  ...
  std::cout<<"-------------------------------------------------------------\n";
  std::cout<<"Size of datetime class is "<< sizeof(datetime<seconds>) << " bytes.\n";
  ...
  std::cout << "Difference = " << mjd2 - mjd1 << " days, or " << (mjd2 - mjd1)*86400e0 << " seconds";
  ...
  std::cout << "The folowing number should be zero: " 
          << ((mjd2 - mjd1)*86400000.0 - 2.5*86400000.0) 
          << ", is it? " << std::boolalpha 
