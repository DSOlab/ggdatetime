...
int main() {
  ...
  /* template parameter is picoseconds */
  {
    ...
    //printf("i1: %d days + %ldps = %ld\n", i1.days(), i1.signed_sec().as_underlying_type(), i1.signed_total_sec().as_underlying_type());
    //printf("i2: %d days + %ldps = %ld\n", i2.days(), i2.signed_sec().as_underlying_type(), i2.signed_total_sec().as_underlying_type());
    //printf("i3: %d days + %ldps = %ld\n", i3.days(), i3.signed_sec().as_underlying_type(), i3.signed_total_sec().as_underlying_type());
    //printf("i1: %d days + %ldps = %ld\n", i1.days(), i1.signed_sec().as_underlying_type(), i1.signed_total_sec().as_underlying_type());
