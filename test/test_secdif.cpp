...
int main() {
  ...
  std::cout << "\nDifference: " << date1_str << " - " << date3_str << " = "
            << df13.as_underlying_type();
  ...
  std::cout << "\nDifference: " << date1_str << " - " << date4_str << " = "
            << df14.as_underlying_type();
  ...
  std::cout << "\nDifference: " << date2_str << " - " << date3_str << " = "
            << df23.as_underlying_type();
  ...
  std::cout << "\nDifference: " << date2_str << " - " << date4_str << " = "
            << df24.as_underlying_type();
  ...
  std::cout << "\nDifference: " << date3_str << " - " << date4_str << " = "
            << df34.as_underlying_type();
