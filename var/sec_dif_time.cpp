...
int main() {
  ...
  std::cout << "\nResults using references -> A:" << diff1_1.count()
            << " B: " << diff1_2.count() << " C: " << diff1_3.count() << " ms ";
  ...
  std::cout << "\nResults using instances  -> A:" << diff2_1.count()
            << " B: " << diff2_2.count() << " C: " << diff2_3.count() << " ms ";
