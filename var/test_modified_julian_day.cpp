...
int main() {
  ...
  assert((dm2 += modified_julian_day(1)) ==
         dm1);               // modified_julian_day += modified_julian_day
  dm2--;                     // modified_julian_day--
  assert((dm1 -= 1) == dm2); // modified_julian_day += Integral_Type
  ++dm1;                     // ++modified_julian_day
  assert((dm1 -= modified_julian_day(1)) ==
         dm2); // modified_julian_day += modified_julian_day
  dm1++;       // modified_julian_day++
